...
export default function Singup(params) {
  ...
  return (
    ...
    <div className="">
      <TopNav />
      <form onSubmit={handleSubmit(onSubmit)} className="darkExtraPage mx-auto m-20 grid w-80 max-sm:w-60 max-sm:p-5 p-10 bg-gray-200 rounded-2xl gap-5">
        ...
        <label htmlFor="" className="grid border rounded-xl p-1">
          Name
          <input {...register("user_name")} placeholder="Enter Full Name" className="" type="text" />
        </label>
        <label htmlFor="" className="grid border rounded-xl p-1">
          Email
          <input {...register("user_email")} placeholder="Enter Email" className="" type="email" />
        </label>
        <label htmlFor="" className="grid border rounded-xl p-1">
          Mobile Number
          <input {...register("user_ph_no")} placeholder="Enter Mobile Number" className="" type="number" />
        </label>
        <label htmlFor="" className="grid border rounded-xl p-1" >
          Password
